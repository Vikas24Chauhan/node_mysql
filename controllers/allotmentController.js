...
// =============== NEET PG Allotments Filters 2025 =================================

export const getPgAllotmentFilters2025 = async (req, res) => {
  try {
    const [
      roundsResult,
      statesResult,
    ...
    console.error("Error fetching PG 2025 filters:", error);

    res.status(500).json({
      success: false,
      message: "Failed to fetch PG 2025 filters",
    });
  }
};

// =============== NEET UG Allotments 2025 =================================

export const getUgAllotments2025 = async (req, res) => {
  try {
    const {
      page = 1,
      limit = 50,
    ...
    console.error("Error fetching UG 2025 allotments:", error);

    res.status(500).json({
      success: false,
      message: "Failed to fetch UG 2025 allotments",
    });
  }
};

// =============== NEET UG Allotments Filters 2025 ==========================

export const getUgAllotmentFilters2025 = async (req, res) => {
  try {
    const [
      roundsResult,
      statesResult,
    ...
    console.error("Error fetching UG 2025 filters:", error);

    res.status(500).json({
      success: false,
      message: "Failed to fetch UG 2025 filters",
    });
  }
};
